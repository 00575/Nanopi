...
wget -P /tmp https://ghproxy.com/https://github.com/huyunlei2020/R2S/raw/zstd-bin/truncate
wget -P /tmp https://ghproxy.com/https://github.com/huyunlei2020/R2S/raw/zstd-bin/ddnz
